...
|----------------------|--------------------|----------------------------------------|-----------------|
| Ngô Xuân Hậu         | Trưởng nhóm        | xử lí physic va chạm, powerUp, hệ thống âm thanh, hình ảnh liên quan...   | 27%  |
| Nguyễn Huy Hoàng     | Thành viên         | Xử lí Bricks và các vấn đề liên quan (create, render, logic, check level complete...)  | 27% |
| Nguyễn Quang Hồng    | Thành viên         | xử lí ball, paddle, powerUp, powerUp system và các vấn đề liên quan (logic, render...) | 27% |
| Nguyễn Ngọc Hưởng    | Thành viên         | Xử lý giao diện ui - chuyển cảnh (menu, pause, gameover,..),sơ đồ lớp, tham gia 1 phần vào logic chính (tính điểm, mất mạng,..)  | 19% |
